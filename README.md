...
- Banco: zerado (novo esquema inicial em `supabase/sql/schema.sql`).
- **Padrão atual:** novos scripts SQL devem ser criados dentro de `supabase/`.
- Aplicação: zerada (novo app base em `app/`).
- Repositório: histórico preservado no Git, mas código reiniciado.

## Próximos passos

1. ✅ Definir protótipo de UX 60+ (tipografia, contraste, fluxo guiado) — ver `docs/UX_PROTOTYPE_60PLUS.md`.
